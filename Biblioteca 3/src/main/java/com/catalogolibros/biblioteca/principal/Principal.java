...
public class Principal {
    ...
    public void muestraMenu() {
        ...
        while (opcion != 0) {
            ...
            switch (opcion) {
                ...
                case 0:
                    System.out.println("Saliendo de la Biblioteca Virtual. ¡Hasta luego!");
                    System.exit(0);
                    break;
                default:
                    System.out.println("Opción no válida. Selecciona algún número que aparezca en el menú");
            }
    ...
    public void mostrarAutoresVivosEnDeterminadoAnio(){
        ...
        if (autoresVivos.isEmpty()){
            System.out.println("No se encontraron autores vivos en el año que indicaste");
        } else {
    ...
    public void listarLibrosPorIdioma(){
        ...
        if ("es".equalsIgnoreCase(idioma)
            ...
            if(libroServicio.listarLibrosPorIdioma(idioma).isEmpty()){
                System.out.println("No se encontro el libro en el idioma seleccionado");
            }
        } else {
            System.out.println("Idioma no encontrado. Por favor, selecciona alguno de los idiomas disponibles en el menú.");
        }
